...
#
###############################################################################
def fun_with_turtles (color, thickness):
    window = rg.TurtleWindow()#initialized the window
    first = rg.SimpleTurtle() #names first turtle
    second = rg.SimpleTurtle()#names second turtle
    first.pen = rg.Pen('green', thickness)
    second.pen = rg.Pen(color, 5)
    first.forward(100)
    second.backward(100)
...
print('length is ',answer)

fun_with_turtles('blue', 20)
fun_with_turtles('yellow',50)